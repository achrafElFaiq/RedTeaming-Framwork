"""
PyritAdapter — Wraps the framework's AttackTarget into a PyRIT-compatible PromptTarget.
========================================================================================

PyRIT requires all attack targets to be instances of `PromptTarget` (its own abstract class).
Our internal targets (AttackTarget) expose `.query(prompt)`; this adapter bridges both models.
"""
