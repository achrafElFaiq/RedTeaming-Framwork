...
def get_runtime_settings(frameworks: set[str] | None = None) -> RuntimeSettings:
    ...
    settings = RuntimeSettings(
        ...
        pyrit_db_path=os.getenv("PYRIT_DB_PATH", "pyrit.db"),
    ...
    if need_pyrit:
        ...
        if not settings.pyrit_attacker_api_key and not os.getenv("PYRIT_ATTACKER_API_KEY_COMMAND"):
            raise ValueError(
        ...
        if not settings.pyrit_scorer_api_key and not os.getenv("PYRIT_SCORER_API_KEY_COMMAND"):
            raise ValueError(
